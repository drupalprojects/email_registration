...
class EmailRegistrationLogin extends Login {
  ...
  public function buildPaneForm(array $pane_form, FormStateInterface $form_state, array &$complete_form) {
    ...
    $pane_form['returning_customer']['name']['#title'] = $login_with_username ? t('E-mail or username') : t('E-mail');
    $pane_form['returning_customer']['name']['#description'] = $login_with_username ? t('Enter your e-mail address or username.') : t('Enter your e-mail address.');
    ...
    $pane_form['returning_customer']['password']['#description'] = t('Enter the password that accompanies your e-mail.');
    ...
    $pane_form['register']['mail']['#title'] = t('E-mail');
    ...
    if ($triggering_element['#op'] === 'login') {
      ...
      if (!empty($mail)) {
        ...
        elseif (!$config->get('login_with_username')) {
          ...
          $form_state->setError($pane_form['returning_customer'], t('Unrecognized e-mail address or password. <a href=":password">Forgot your password?</a>', [
      ...
      if (user_is_blocked($username)) {
        $form_state->setError($name_element, $this->t('The account with e-mail address %mail has not been activated or is blocked.', ['%mail' => $mail]));
        return;
      }
      ...
      if (!$uid) {
        $this->credentialsCheckFlood->register($this->clientIp, $username);
        $form_state->setError($name_element, $this->t('Unrecognized e-mail address or password. <a href=":password">Forgot your password?</a>', [':url' => $password_url]));
      }
